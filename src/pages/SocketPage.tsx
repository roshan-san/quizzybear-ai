  ...
  return (
    ...
    >
      ...
      <h1 className="text-white text-center py-10 text-3xl md:text-4xl font-medium">
        QuizzyBear AI <span className="text-nowrap">Multi-Player</span>
      </h1>
      ...
      {(stage == 1 || stage == 2) && (
        <div className="flex justify-center pb-10">
          <h2 className="text-white text-center md:text-xl lg:max-w-[70%] px-2">
            ...
            <b className="text-nowrap">QuizzyBear AI's Multiplayer Mode!</b> <br />
            Compete in real-time and prove who's the ultimate quiz master.
          </h2>
        </div>
      )}
